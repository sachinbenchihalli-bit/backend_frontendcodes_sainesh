...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      hover:outline-none hover:ring-1 hover:ring-ring
      active:outline-none active:ring-1 active:ring-ring data-[state=open]:outline-none data-[state=open]:ring-1 data-[state=open]:ring-ring`,
      className
    )}
    {...props}
  >
